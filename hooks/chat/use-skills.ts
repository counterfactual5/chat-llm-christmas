...
/**
 * Skill list, picker attach/toggle, and create/delete modal flows.
 */
...
export function useChatSkills(opts: {
  ...
  const createSkill = useCallback(async (title: string, content: string) => {
    ...
    try {
      ...
      if (json.success || json.data) {
        const saved =
          json.data || { id: crypto.randomUUID(), title: trimmedTitle, content: trimmedContent };
