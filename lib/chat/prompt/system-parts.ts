/**
 * Assemble chat system-prompt parts.
 * Pure string assembly — client-safe (no server I/O).
 */
...
import { domainPolicyPrompt } from '@/lib/chat/prompt/domain-policy';
import {
...
export type ChatSystemSkillInput = {
  title?: string;
  content?: string;
};
