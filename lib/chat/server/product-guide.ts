...
export function productUsageGuideDetailPrompt(): string {
  return [
    ...
    '- file_read: lazy built-in when the chat has attached PDF/DOCX/Excel/text docs. Latest-turn attaches include full extracted text; older turns show 【历史文件引用】 with a short preview + fileId — call file_read with that file_id to re-read the full body. Never invent file contents.',
