...
export function productUsageGuideDetailPrompt(): string {
  return [
    ...
    '- file_read: 【历史文件引用】 markers carry fileId — call file_read with that file_id for a short page slice (~8 by default). Omit start_page to skip TOC when possible; pass start_page / focus to continue. Never invent file contents.',
