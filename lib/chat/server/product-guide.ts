...
export function productUsageGuideDetailPrompt(): string {
  return [
    ...
    '- Sidebar Tools can disable web search. There is no first-class finance/crypto/FX data product — with search ON you may look up public market/news pages and must label source, time, and whether data is live vs historical. Domain Skills may add extra workflows when ACTIVE.',
