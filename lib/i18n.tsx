...
const dict = {
  en: {
    ...
    notionNotConfigured: 'Notion OAuth is not configured on the server',
    notionConnectHint: 'Authorize your own workspace — never shared with other users',
    notionConnectCardTitle: 'Notion',
    notionConnectCardBody: 'Search, read, and edit pages shared with Christmas Chat.',
    writingNotion: 'Updating Notion…',
    wroteNotion: 'Updated Notion',
    notionWorkspace: 'Workspace',
    mcpTools: 'MCP',
    enableNotionMcp: 'Notion',
    enableNotionMcpHint: 'Search and read your connected Notion in this chat',
  ...
  zh: {
    ...
    notionNotConfigured: '服务器尚未配置 Notion OAuth',
    notionConnectHint: '授权你自己的工作区，不会与其他用户共用',
    notionConnectCardTitle: 'Notion',
    notionConnectCardBody: '搜索、阅读并编辑分享给 Christmas Chat 的页面。',
    writingNotion: '正在更新 Notion…',
    wroteNotion: '已更新 Notion',
    notionWorkspace: '工作区',
    mcpTools: 'MCP',
    enableNotionMcp: 'Notion',
    enableNotionMcpHint: '在本对话中搜索并阅读已连接的 Notion',
