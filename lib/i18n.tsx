...
const dict = {
  en: {
    ...
    noSkillsYet: 'No skills yet — create one in the sidebar',
    ...
    addReferenceNotes: 'Add reference notes',
    editReferenceNotes: 'Edit reference notes',
    collapseReferenceNotes: 'Collapse',
    referenceNotesLabel: 'Notes',
    referenceNotesBadge: 'notes',
  ...
  zh: {
    ...
    addReferenceNotes: '添加参考资料',
    editReferenceNotes: '编辑参考资料',
    collapseReferenceNotes: '收起',
    referenceNotesLabel: '手动备注',
    referenceNotesBadge: '备注',
    requestFailed: '请求失败',
    retry: '重试',
    continue: '继续',
    stop: '停止',
