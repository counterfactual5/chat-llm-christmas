...
const dict = {
  en: {
    ...
    enableZhipuVisionMcp: 'Zhipu Vision',
    zhipuVisionMcpHint: 'Image understanding via GLM-4.6V (billed to your account)',
    ...
    imagesPreferVision: 'Images will be processed via Zhipu Vision. For best accuracy, use a Vision model.',
  ...
  zh: {
    ...
    enableZhipuVisionMcp: '智谱视觉',
    zhipuVisionMcpHint: '通过 GLM-4.6V 识别图像（从您的账户余额计费）',
    zhipuVisionMcpNeedsLogin: '请先登录以使用图像识别',
    imagesNeedVision: '对话中包含图片，请切换到 Vision 模型。',
    imagesPreferVision: '图片将通过智谱视觉处理。为获得更好的效果，建议使用 Vision 模型。',
