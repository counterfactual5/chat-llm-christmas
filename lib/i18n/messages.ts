...
export const dict = {
  en: {
    ...
    researchSourceNews: 'News',
    researchSourceNewsHint: 'Headlines / Google News',
    researchSourceWiki: 'Wiki',
    researchSourceWikiHint: 'Wikipedia encyclopedia lookup',
    researchSourceMixed: 'Mixed',
    researchSourceMixedHint: 'Web + literature together',
    ...
    newsCommand: 'News',
    newsCommandHint: 'News search — /news <query>',
    wikiCommand: 'Wiki',
    wikiCommandHint: 'Wikipedia — /wiki [zh|en] <query>',
    writeMessage: 'Ask {model}…  (/image, /research, /news, /wiki, /papers, /books, /review, /skills)',
    quote: 'Quote',
    quoted: 'Quoted',
  ...
  zh: {
    ...
    researchSourceNews: '新闻',
    researchSourceNewsHint: '头条 / Google News',
    researchSourceWiki: '百科',
    researchSourceWikiHint: '维基百科查证',
    researchSourceMixed: '混合',
    researchSourceMixedHint: '网页与文献一起检索',
    papersCommand: '论文检索',
    ...
    newsCommand: '新闻检索',
    newsCommandHint: '新闻检索 — /news <query>',
    wikiCommand: '百科检索',
    wikiCommandHint: '维基百科 — /wiki [zh|en] <query>',
    writeMessage: '问 {model}…  (/image、/research、/news、/wiki、/papers、/books、/review、/skills)',
    quote: '引用',
    quoted: '引用',
    quotedCount: '引用（{n}）',
    clearQuote: '取消引用',
