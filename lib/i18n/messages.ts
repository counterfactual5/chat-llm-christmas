...
export const dict = {
  en: {
    ...
    notionNeedsReconnect: 'Notion connection expired — reconnect to continue',
    notionAuthRequired:
      'Notion tools failed authorization — reconnect Notion in Settings, then try again.',
    connectGitHub: 'Connect GitHub',
    disconnectGitHub: 'Disconnect GitHub',
    reconnectGitHub: 'Reconnect GitHub',
    githubNeedsReconnect: 'GitHub connection expired — reconnect to continue',
    githubAuthRequired:
      'GitHub tools failed authorization — reconnect GitHub in Settings, then try again.',
    ...
    urlPreviewResolvingBook: 'Looking for an open book file…',
    ...
    urlPreviewImageLoading: 'Loading image…',
    urlPreviewImagePlaceholderAlt: 'Image',
    urlPreviewImageUnderstand: 'Describe image',
    urlPreviewImageUnderstanding: 'Understanding…',
    urlPreviewImageDescriptionLabel: 'Image description',
    dismiss: 'Dismiss',
    ...
    loading: 'Loading…',
    extractingPreview: 'Extracting…',
    extractPreviewFailed: 'Could not extract a preview for this file',
    ...
    exportAllDataHint: 'Sessions + memories as JSON',
    exportAllDataHintGuest: 'Local sessions only',
    exportAllDataWaitHydrate: 'Wait for chats to finish syncing, then try again.',
    exportAllDataMemoriesFailed: 'Could not load memories — export cancelled.',
    exportAllDataMemoriesTruncated:
      'Export saved, but memories may be truncated (API page limit).',
    exportAllDataBusy: 'Export already in progress…',
    signOut: 'Sign out',
    ...
    writingOffice: 'Editing Office file…',
    wroteOffice: 'Edited Office file',
    rollingBackOffice: 'Undoing Office edit…',
    rolledBackOffice: 'Undid Office edit',
    officeUndo: 'Undo',
    officeUndoing: 'Undoing…',
    officeUndoDone: 'Undone',
  ...
  zh: {
    ...
    notionNeedsReconnect: 'Notion 连接已失效 — 请重新连接后继续',
    notionAuthRequired: 'Notion 工具鉴权失败 — 请在设置中重新连接 Notion 后再试。',
    connectGitHub: '连接 GitHub',
    disconnectGitHub: '断开 GitHub',
    reconnectGitHub: '重新连接 GitHub',
    githubNeedsReconnect: 'GitHub 连接已失效 — 请重新连接后继续',
    githubAuthRequired: 'GitHub 工具鉴权失败 — 请在设置中重新连接 GitHub 后再试。',
    ...
    urlPreviewResolvingBook: '正在查找可预览的图书文件…',
    ...
    urlPreviewImageLoading: '图片加载中…',
    urlPreviewImagePlaceholderAlt: '图片',
    urlPreviewImageUnderstand: '加载图片描述',
    urlPreviewImageUnderstanding: '理解中…',
    urlPreviewImageDescriptionLabel: '图片描述',
    dismiss: '关闭',
    openInNewTab: '新窗口打开',
    toolViewPanel: '专项视图',
    ...
    noFreeModels: '暂无免费模型。',
    loading: '加载中…',
    extractingPreview: '解析中…',
    extractPreviewFailed: '无法解析该文件的预览',
    loadingModels: '加载模型…',
    selectModel: '选择模型',
    ...
    exportAllDataHint: '会话 + 记忆（JSON）',
    exportAllDataHintGuest: '仅本机会话',
    exportAllDataWaitHydrate: '请等待会话同步完成后再导出。',
    exportAllDataMemoriesFailed: '无法加载记忆 — 已取消导出。',
    exportAllDataMemoriesTruncated: '已导出，但记忆可能被分页截断。',
    exportAllDataBusy: '正在导出…',
    signOut: '退出登录',
    connect: '连接账号',
    messagesCount: '{n} 条消息',
    generating: '生成中',
    ...
    extractedXlsx: '已提取表格',
    writingOffice: '正在编辑 Office 文件…',
    wroteOffice: '已编辑 Office 文件',
    rollingBackOffice: '正在撤销 Office 编辑…',
    rolledBackOffice: '已撤销 Office 编辑',
    officeUndo: '撤销',
    officeUndoing: '撤销中…',
    officeUndoDone: '已撤销',
    openToolView: '打开视图',
