...
export const dict = {
  en: {
    ...
    papersCommandHint: 'Search academic papers (arXiv / OpenAlex / S2)',
    booksCommand: 'Books',
    booksCommandHint: 'Search legal books (Open Library / Internet Archive)',
  ...
  zh: {
    ...
    papersCommand: '论文检索',
    papersCommandHint: '学术论文（arXiv / OpenAlex / Semantic Scholar）',
    booksCommand: '书籍检索',
    booksCommandHint: '合法书源（Open Library / Internet Archive）',
