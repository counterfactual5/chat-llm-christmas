...
export const dict = {
  en: {
    ...
    previewPanelEmpty: 'Click a file in the chat or Output to preview it here',
    toolViewPanel: 'View',
    ...
    processWaitingDetail: 'Waiting the models…',
    ...
    researchModeQuickHint: 'Fewer searches · faster',
  ...
  zh: {
    ...
    context: '上下文',
    previewPanel: '预览',
    previewPanelEmpty: '在对话或产出框中点击文件，即可在此预览',
    toolViewPanel: '专项视图',
    ...
    researchModeQuick: '快速',
    researchModeQuickHint: '少搜几轮 · 更快出结果',
