/**
 * Web search provider implementations + fallback order.
 */
...
import { decodeEntities, trimHit } from '@/lib/tools/search/freshness';
import { MAX_RESULTS, type SearchHit } from '@/lib/tools/search/types';
