...
const WEB_READ_SYSTEM_PROMPT = [
  ...
  'Do NOT web_read Google News / news.google.com /rss/articles/ redirect URLs — they usually fail. Prefer the publisher’s own article URL from the hit, or answer from search title+snippet if that is all you have.',
